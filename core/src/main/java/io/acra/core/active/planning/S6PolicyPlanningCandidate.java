...
public record S6PolicyPlanningCandidate(
        String candidateId,
        Endpoint endpoint,
        ...
        EffectiveAuthorizationResolution baselineResolution,
        EffectiveAuthorizationResolution targetResolution,
    ...
    public S6PolicyPlanningCandidate {
        ...
        if (endpoint == null || baseline == null || positiveControl == null || negativeControl == null
            ...
            throw new IllegalArgumentException("complete S6 planning candidate required");
        }
