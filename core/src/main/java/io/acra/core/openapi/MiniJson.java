...
public final class MiniJson {
    ...
    public static Object parse(String s){MiniJson p=new MiniJson(s);Object v=p.value();p.ws();if(p.i!=s.length())throw new IllegalArgumentException("trailing JSON at "+p.i);return v;}
