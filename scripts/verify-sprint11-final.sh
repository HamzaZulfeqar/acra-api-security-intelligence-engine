...
echo "ACRA SPRINT 11 FINAL VERIFICATION"
...
java -ea -Djava.awt.headless=true -cp "$CP" io.acra.burp.tests.sprint11.Sprint11FindingReviewUiTestSuite

bash ./scripts/package-sprint11.sh

echo "SPRINT11_FINAL_VERIFICATION PASS"
