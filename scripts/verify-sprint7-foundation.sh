...
java -ea -cp "$CP" io.acra.core.tests.sprint7.Sprint7WorkflowAssessmentIntegrationTestSuite
java -ea -cp "$CP" io.acra.core.tests.sprint7.Sprint7WorkflowPlannerExecutionIntegrationTestSuite
