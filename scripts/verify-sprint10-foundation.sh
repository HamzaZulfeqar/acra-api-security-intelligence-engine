...
java -ea -cp "$CP" io.acra.core.tests.sprint10.Sprint10CoverageAccountingTestSuite
...
java -ea -cp "$CP" io.acra.core.tests.sprint10.Sprint10BatchIndirectPerformanceObservationTestSuite
